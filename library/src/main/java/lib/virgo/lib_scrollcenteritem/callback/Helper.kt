...
import lib.virgo.lib_scrollcenteritem.Direction
import lib.virgo.lib_scrollcenteritem.ScrollToCenterLayoutManager
...
interface Helper {
    ...
    fun hasNewBecomeVisible(lm: ScrollToCenterLayoutManager): Boolean
